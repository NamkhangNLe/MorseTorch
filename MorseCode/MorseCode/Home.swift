            ...
            ZStack {
                ...
                VStack {
                    ...
                    Button(action: {
                        ...
                        ImagePicker(selectedImage: $imageSelected, sourceType: .camera, videoSelected: $videoSelected, imageURL: $url)} /*.onDisappear {
                                                                                                                                        //Script call
                                                                                                                                        if (!type && !openCameraRoll) {
                                                                                                                                        if let pathString = url?.path {
                                                                                                                                        let framesArray: [[[Int]]]  = get3DVideoArray(x: pathString)
                                                                                                                                        let MSarr: [Int] = makeModemap(in: framesArray)
                                                                                                                                        }
                                                                                                                                        }                                                                                                                  }*/
                Button(action: {
                    photo = true
                    ...
                    ImagePicker(selectedImage: $imageSelected, sourceType: .photoLibrary, videoSelected: $videoSelected, imageURL: $url)
                        /*.onDisappear {
                        //Script call
                        if let pathString = url?.path {
                            let framesArray: [[[Int]]]  = get3DVideoArray(x: pathString)
